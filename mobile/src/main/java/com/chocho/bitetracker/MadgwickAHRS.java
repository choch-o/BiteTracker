...
public class MadgwickAHRS {
    ...
    static final float sampleFreqDef = 512.0f;  // sample frequency in Hz

    float beta;         // algorithm gain
    float q0;
    float q1;
    float q2;
    float q3;           // quaternion of sensor frame relative to auxilary frame
    ...
    float invSqrt(float x) {
        ...
        x *= (1.5f - halfx * x * x);
        x *= (1.5f - halfx * x * x);  // 2nd iteration, this can be removed
        return x;
    }
