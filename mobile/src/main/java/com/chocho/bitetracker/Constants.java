...
public class Constants {
	// Parameters
	public final static String[] CLASS_LABELS = {"left", "center", "right"}; // Should be predefined before collecting data
	public final static String[] ARFF_FILE_NAMES = {"left.txt", "center.txt", "right.txt"}; // Will be used for model building after merging
	public final static String WORKING_DIR_NAME = "activityRecognition"; // Folder name in SD card
	public final static int SENSOR_DELAY = SensorManager.SENSOR_DELAY_FASTEST; //
	
	public final static int DURATION_THREAD_SLEEP = 200; // ms (Should be smaller than step_size, otherwise bottle neck occurs)
	public final static int WINDOW_SIZE = 500; // ms
	public final static int STEP_SIZE = 100; // ms
